...
class CardBloc extends Validators implements BlocBase {
  final BehaviorSubject<String> _cardHolderName = BehaviorSubject<String>();
  final BehaviorSubject<String> _cardNumber = BehaviorSubject<String>();
  final BehaviorSubject<String> _cardMonth = BehaviorSubject<String>();
  final BehaviorSubject<String> _cardYear = BehaviorSubject<String>();
  final BehaviorSubject<String> _cardCvv = BehaviorSubject<String>();
  final BehaviorSubject<String> _cardType = BehaviorSubject<String>();
  final BehaviorSubject<int> _cardColorIndexSelected =
      BehaviorSubject<int>();
  ...
  void selectCardColor(int colorIndex) {
    for (var element in CardColor.cardColors) {
